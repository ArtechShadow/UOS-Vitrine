...
any generation or placement defect, was traced to an outlier-inflated automatic depth band; a
robust p5--p95 band (commit \texttt{ec4560e}) restores a clean $\approx$0.5-unit radio cluster
(2{,}093 Gaussians), and the remaining gap is scorer projection alignment rather than the carve.
% SRC: runs/nc04-generate-pass1/recarve_score.log
Before that fix, the leak was what capped silhouette-refined placement until the carve was
cleaned.
