...
Open at closeout: the quality-ranking chart (per-object silhouette IoU / masked-DINO across lanes)
remains deferred --- the carve is de-contaminated, but the scoring pass against the clean subset
currently returns degenerate zeros (a projection-domain alignment issue under diagnosis), so no
ranking is published until that is resolved.
