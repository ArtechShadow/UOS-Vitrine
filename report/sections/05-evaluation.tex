...
every Lane-A and Lane-B variant clears the 32\,GB ceiling. Quality ranking is not, and the reason is
diagnosed.\label{sec:eval-ranking} The numeric silhouette scores stay low regardless of the
scale/translation search because the pass-2 radio Gaussian subset has an extent of about
$15.8\times3.1\times10.7$ units in a scene of scale 9.2 --- the carve has picked up wall and floor,
not just the radio. The emplacement anchor (centroid and extent) is therefore unreliable, so absolute
...
and no numeric lane winner is claimed. \todo{Quality-ranking chart: per-object silhouette IoU /
masked-DINO across lanes, once the carve is de-contaminated and refined scoring lands.}
